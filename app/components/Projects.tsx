  ...
  return (
    <div id="projects" className="w-full px-[12%] ">
      ...
      <motion.p
        ...
        className="text-center text-secondaryText dark:text-secondaryText-dark mb-10 max-w-2xl mx-auto"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-10">
        {currentProjects.map((project) => (
          <motion.div
            ...
            key={project.id}
            className="border-[0.5px] border-gray-400 dark:border-secondaryText rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-secondaryText/20 duration-500 cursor-pointer overflow-hidden group bg-white dark:bg-gray-900"
          >
            ...
            <div className="p-6">
              ...
              {/* Technologies Used */}
              <div className="mb-4">
                <h4 className="text-xs font-medium text-gray-700 dark:text-secondaryText-dark mb-2">
                  Technologies Used
                </h4>
                <div className="flex flex-wrap gap-2">
                  {project.techNames.map((tech, index) => (
                    <span
                      key={index}
                      className="text-[11px] sm:text-xs px-2 py-1 border border-secondaryText-dark dark:border-secondaryText rounded-full bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:-translate-y-1 duration-300"
                    >
                      {tech}
                    </span>
                  ))}
